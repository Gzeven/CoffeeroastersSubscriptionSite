...
//       <div className="flex flex-col  xl:flex-row items-center justify-center xl:justify-start bg-dark-grey-blue mx-6 mb-[72px] md:mx-[40px] py-[54px] max-w-[1280px] xl:px-[85px] xl:h-[120px] w-full mx-auto">
//         {/* Logo */}
//         <Image
...
//           <Link href="/" className="hover:text-light-cream transition">Home</Link>
//           <Link href="/about" className="hover:text-light-cream transition">About Us</Link>
//           <Link href="/subscribe" className="hover:text-light-cream transition">Create Your Plan</Link>
//         </nav>

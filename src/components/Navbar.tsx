...
>
  <ul className="flex flex-col items-center justify-start h-full space-y-8 font-bold text-xl text-dark-grey-blue pt-8 font-heading text-2xl">
    <li>
      <Link href="/" onClick={() => setIsOpen(false)} tabIndex={isOpen ? 0 : -1}>
        Home
      </Link>
    </li>
    <li>
      <Link href="/about" onClick={() => setIsOpen(false)} tabIndex={isOpen ? 0 : -1}>
        About Us
      </Link>
    </li>
    <li>
      <Link href="/subscribe" onClick={() => setIsOpen(false)} tabIndex={isOpen ? 0 : -1}>
        Create Your Plan
      </Link>
    </li>
  </ul>

...
//           <Link href="/" className="w-full flex-1 m-6 md:m-0 md:w-auto flex justify-center items-center h-14 bg-dark-cyan text-light-cream font-heading text-lg rounded-md transition duration-300 hover:bg-light-blue" >
//             <span>Checkout</span>

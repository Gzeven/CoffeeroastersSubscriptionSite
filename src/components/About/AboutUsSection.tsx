...
const images = [
  { src: "/images/about/desktop/image-hero-whitecup.jpg", className: "hidden xl:block", minWidth: 1280 },
  { src: "/images/about/tablet/image-hero-whitecup.jpg", className: "hidden md:block xl:hidden", minWidth: 768 },
  { src: "/images/about/mobile/image-hero-whitecup.jpg", className: "block md:hidden", minWidth: 0 }
];

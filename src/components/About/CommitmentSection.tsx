...
const images = [
  { src: "/images/about/desktop/image-commitment.jpg", className: "hidden xl:block rounded-lg", minWidth: 1280 },
  { src: "/images/about/tablet/image-commitment.jpg", className: "hidden md:block xl:hidden rounded-lg", minWidth: 768 },
  { src: "/images/about/mobile/image-commitment.jpg", className: "block md:hidden rounded-[10px]", minWidth: 0 }
];
